  ...
  return (
    <div className={className}>
      ...
      <input
        ...
        className={`mt-1.5 block w-full rounded-lg bg-navy-900/70 px-3.5 py-2.5 text-sm text-ink-100 ring-1 ring-inset transition placeholder:text-ink-500 focus:bg-navy-900 focus:ring-2 focus:ring-inset focus:outline-none ${
          error
