...
Column names and types in all three must be exactly what `db/migration/V1`, `V2` and `V3`
create. `ddl-auto=validate` means the entities already have to agree with the migrations, so
