...
| 2 | Personal weekly report (create/edit) | `/reports/new`, `/reports/:id/edit` | Team Member | not started |
| 3 | Report history (per user) | `/reports` | Team Member | list view done (Phase 4); row links to detail come with Phase 5 |
| 4 | Report detail / view (read-only) | `/reports/:id` | both | not started |
...
| 10 | Account settings *(extra, optional)* | `/settings` | both | not started |
